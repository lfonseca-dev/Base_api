...
function Login({ setIsAuth }) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post('http://localhost:9099/api/usuario/login', { email, senha })
        ...
        <div className="min-h-screen flex items-center justify-center bg-linear-to-r from-zinc-900 to-zinc-800">
            ...
            <div className="bg-zinc-900 p-10 rounded-2xl shadow-2xl w-full max-w-md">
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-5">
                    ...
                    <button
                        className="w-full bg-red-800 hover:bg-red-950 text-white font-semibold py-3 rounded-lg transition duration-300 shadow-lg"
                        type="submit">
                        Login
                    </button>
                </form>
